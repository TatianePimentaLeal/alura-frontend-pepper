...
const btnCancelar = document.querySelector('.app__form-footer__button')
...
let tarefaSelecionada = null //só inicializando
...
btnDeletar.addEventListener('click', () => {
    if(tarefaSelecionada) {
        ...
        tarefas.filter(t => t != tarefaSelecionada) //criando uma nova array sem essa tarefa que foi removida
        itemTarefaSelecionada = null
        tarefaSelecionada = null
    }
    updateLocalStorage()
